...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('api', '0002_personaldata_delete_item'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('residential_telephone_no', models.CharField(blank=True, max_length=20)),
                ('permanent_address', models.TextField()),
                ('permanent_zip_code', models.CharField(max_length=10)),
                ('permanent_telephone_no', models.CharField(blank=True, max_length=20)),
